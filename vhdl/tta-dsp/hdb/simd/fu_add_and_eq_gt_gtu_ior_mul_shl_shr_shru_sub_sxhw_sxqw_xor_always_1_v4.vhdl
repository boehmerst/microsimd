...
entity fu_add_and_eq_gt_gtu_ior_mul_shl_shr_shru_sub_sxhw_sxqw_xor_always_1_v4 is
  port(
    ...
    rstx	 : in std_logic;
    clk	 : in std_logic);
end fu_add_and_eq_gt_gtu_ior_mul_shl_shr_shru_sub_sxhw_sxqw_xor_always_1_v4;

architecture rtl of fu_add_and_eq_gt_gtu_ior_mul_shl_shr_shru_sub_sxhw_sxqw_xor_always_1_v4 is
...
FU_GEN :
   for i in 0 to 3 generate
     begin
      fu_add_and_eq_gt_gtu_ior_mul_shl_shr_shru_sub_sxhw_sxqw_xor_always_1_inst : entity work.fu_add_and_eq_gt_gtu_ior_mul_shl_shr_shru_sub_sxhw_sxqw_xor_always_1
        generic map(
          dataw	 => 32)
        port map(
  ...
  input_control: process (t1opcode, t1data, o1data)
  begin
    case t1opcode is
      when "1011" =>  -- SXHW32X4
